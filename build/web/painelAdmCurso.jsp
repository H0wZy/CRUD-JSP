...
<html>
    ...
    <body>
        <header>
            <nav class="navbar">
                <div class="navbar-left">
                    <a href="#" class="navbar-brand">Painel Curso</a>
                </div>
        ...
        <main>
            ...
            <a href="cadastroCurso.jsp"> <button type="button" name="cadastrar">Cadastrar novo curso</button> </a>
            <table class="table table-bordered mt-5 w-75 mx-auto">
                <thead>
                    <tr>
                        ...
                        <th>Nome</th>
                        <th>Descrição</th>
                        <th style="width: 140px;">Carga horária</th>
                ...
                <tbody>
                    <%
                        ...
                        while (rs.next()) {
                            ...
                            out.print("<td style='text-align: left;'>" + rs.getString(4) + " Horas</td>");
                            out.print("<td> <a href='alterarCurso.jsp?id=" + rs.getString(1) + "'> <button class='action-btn edit-btn'><i class='bi bi-pencil-square'></i>Alterar</button> </a></td>");
                            out.print("<td> <a href='excluirCurso.jsp?id=" + rs.getString(1) + "'> <button class='action-btn delete-btn'><i class='bi bi-trash-fill'></i>Excluir</button> </a> </td>");
                            out.print("</tr>");
                        }
                    %>
                </tbody>
